...
class Ships extends \yii\db\ActiveRecord
{
    ...
    public function rules(): array
    {
        return [
            [['name', 'slug'], 'required'],
            [['typeId', 'operatorId', 'stars', 'status', 'priority', 'passengers', 'decksTotal', 'cabinsTotal', 'year', 'yearRenovation'], 'integer'],
            ...
            [['operatorId'], 'exist', 'skipOnError' => true, 'targetClass' => Operators::class, 'targetAttribute' => ['operatorId' => 'id']],
            [['typeId'], 'exist', 'skipOnError' => true, 'targetClass' => ShipTypes::class, 'targetAttribute' => ['typeId' => 'id']],
        ];
    }
